    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 flex-shrink-0">
          <h2 className="text-lg font-bold text-[#0F2B5B]">{title}</h2>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex-shrink-0">
          <button
            onClick={onClose}
            className="w-full bg-[#0F2B5B] hover:bg-[#1a3d7c] text-white py-3 rounded-xl font-semibold text-sm transition-colors"
          >
            Close
          </button>
        </div>
